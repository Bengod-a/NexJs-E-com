...
export default function Header() {
  ...
  return (
    <header className="bg-white  h-fit sticky top-0 z-50 self-start">
        ...
        <form onSubmit={handleSearch} className="w-[500px] mt-2 sm:mt-0">
          ...
          >
            <input
              ...
              className="w-[500px] py-2 px-4 pl-10 border-b-2 border-b-gray-300 text-gray-600 focus:outline-none focus:border-b-red-500 transition-colors duration-300"
            />
            <button
              type="submit"
          ...
          <Link href={"/user/cart"} className=" cursor-pointer">
            <div className="relative">
              ...
              <span className="absolute -top-1 -right-1 bg-red-600 text-white text-xs rounded-full px-1">
                {productOnCart.length > 0 ? productOnCart.length : null}
              </span>
            </div>
          </Link>
        </motion.div>
